...
$sql = "update navio set nome=?, tipo=?, numero=? where id_navio = ?";
$stmt = $mysqli->prepare($sql);

// vincula valores nas variaveis as marcacoes ??
$stmt->bind_param("siii", $nome, $tipo, $numero, $id_navio);
...
if ($stmt->execute() === TRUE) {
  ...
  echo "Navio atualizado com sucesso!";
  ...
  echo "Erro ao atualizar navio: " . $mysqli->error;
}

echo "<br>\n<br>\n<a href=\"../index.html\">Página inicial</a>\n";
echo "<br>\n<br>\n<a href=\"../mostrar/mostrarnavio.php\">Ver navios</a>\n";
